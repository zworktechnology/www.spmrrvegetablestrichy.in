<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="todaystockLargeModalLabel"><span style="color:green">SALES - {{ $allbranches->shop_name }} STOCK</span></h5>
                  ...
                  <div class="row">
                     <div class="col-lg-12 col-sm-12 col-12">
                        <div class="row" style="background-color: lightgray">
                              ...
                              <div class="col-lg-3 col-sm-3 col-3 border">
                                 <span class="" style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 700;line-height: 35px; ">Customer</span>
                              </div>
                      ...
                      @if ($allbranches->id == $p_datas['branch_id'])
                        ...
                        <div class="row">
                              ...
                              <div class="col-lg-3 col-sm-3 col-3 border">
                                 <span class="" style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 700;line-height: 35px; ">{{$p_datas['Sales_Customer']}}</span>
                              </div>
                              <div class="col-lg-4 col-sm-4 col-4 border">
                             ...
                             <div class="col-lg-2 col-sm-2 col-2 border">
                                <span class="" style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 700;line-height: 35px; ">{{$p_datas['salesproduct_count']}} {{$p_datas['salesbag_kg']}}</span>
                             </div>
                        </div>
                        @endif
                        @endforeach
