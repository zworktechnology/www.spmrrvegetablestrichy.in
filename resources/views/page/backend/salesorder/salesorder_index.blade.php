                    ...
                    <table class="table  customerdatanew">
                        ...
                        <tbody>
                            @foreach ($Sales_data as $keydata => $Sales_datas)
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled hstack gap-1 mb-0">
                                            ...
                                            @endif
                                            <li>
                                                <a href="#salesorderview{{ $Sales_datas['unique_key'] }}"
                                                    data-bs-toggle="modal" data-id="{{ $Sales_datas['id'] }}"
                                ...
                                <div class="modal fade salesorderview-modal-xl{{ $Sales_datas['unique_key'] }}"
