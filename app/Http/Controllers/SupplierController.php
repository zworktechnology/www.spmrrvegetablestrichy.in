...
class SupplierController extends Controller
{
    ...
    public function supplierview($unique_key, $last_word)
    {
        ...
        if($last_word != 'supplier'){
            ...
            $tot_purchaseAmount = $tot_purchaseAmounts + $paymentpurchase_discount;
