...
@section('content')
                            ...
                            <div class="about-one__btn-and-ceo">
                                ...
                                <div class="about-one__ceo">
                                    <div class="about-one__ceo-img">
                                        <img src="{{ asset('assets/frontend/images/resources/about-one-ceo-img.jpg') }}" alt="">
                                    </div>
                        ...
                        <div class="about-one__right">
                            <div class="about-one__img-box wow slideInRight" data-wow-delay="100ms"
                                ...
                                <div class="about-one__img-two">
                                    <img src="{{ asset('assets/frontend/images/resources/about-one-img-2.jpg') }}" alt="">
                                </div>
        ...
        <section class="services-one" id="services">
            <div class="services-one__bg"
                style="background-image: url(assets/images/shapes/services-one-shape-1.png);">
            </div>
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="services-one__single">
                            <div class="services-one__img-box">
                                <div class="services-one__img">
                                    <img src="{{ asset('assets/frontend/images/services/services-one-1.jpg') }}" alt="">
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="200ms">
                        <div class="services-one__single">
                            <div class="services-one__img-box">
                                <div class="services-one__img">
                                    <img src="{{ asset('assets/frontend/images/services/services-one-2.jpg') }}" alt="">
                                </div>
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="300ms">
                        <div class="services-one__single">
                            <div class="services-one__img-box">
                                <div class="services-one__img">
                                    <img src="{{ asset('assets/frontend/images/services/services-one-3.jpg') }}" alt="">
                                </div>
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="400ms">
                        <div class="services-one__single">
                            <div class="services-one__img-box">
                                <div class="services-one__img">
                                    <img src="{{ asset('assets/frontend/images/services/services-one-4.jpg') }}" alt="">
                                </div>
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-6">
                        <div class="healthy-food-one__left">
                            <div class="healthy-food-one__img">
                                <img src="{{ asset('assets/frontend/images/resources/healthy-food-one-1.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                                ...
                                <div class="item">
                                    <div class="testimonial-one__single">
                                        <div class="testimonial-one__content">
                                            ...
                                            <div class="testimonial-one__client-info">
                                                <div class="testimonial-one__client-img">
                                                    <img src="assets/images/testimonial/testimonial-1-5.jpg"
                                                        alt="">
                                                    <div class="testimonial-one__quote">
                                                        <span class="icon-quote"></span>
                                                    </div>
                                ...
                                <div class="item">
                                    <div class="testimonial-one__single">
                                        <div class="testimonial-one__content">
                                            ...
                                            <div class="testimonial-one__client-info">
                                                <div class="testimonial-one__client-img">
                                                    <img src="assets/images/testimonial/testimonial-1-6.jpg"
                                                        alt="">
                                                    <div class="testimonial-one__quote">
                                                        <span class="icon-quote"></span>
                                                    </div>
