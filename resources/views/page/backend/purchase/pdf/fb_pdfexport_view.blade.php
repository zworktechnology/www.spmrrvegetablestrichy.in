...
<body>
    ...
    <table id="customers">
            ...
            <tr>
                <th style="background-color: #fff;font-size:14px;border:1px #fff">Date : {{$fromdate}}</th>
                <th style="background-color: #fff;font-size:14px;border:1px #fff">Branch : {{$branch}}</th>
            </tr>
      </table>
