            ...
            <div class="row py-2">
               ...
               @if ($Purchaseextracosts)
                  <table style="width: 100%;line-height: inherit;text-align: left;overflow: auto;margin:15px auto;">
                     ...
                     <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                        <td style="padding: 7px;vertical-align: top; vertical-align: inherit;vertical-align: inherit;font-size: 11px;color:#000;font-weight: 600;">{{ $Purchaseextracosts_arr->extracost_note }}</td>
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-5  col-sm-7 col-9">
                           <div class="total-order w-100 max-widthauto">
                              <ul>
                                 <li>
                                    <h4 style="font-size: 11px;color:blue;font-weight: 600;">Commission Amount</h4>
                                    <h5 style="font-size: 11px;color:blue;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->commission_amount}}({{$PurchaseData->commission_percent}} %)</span></h5>
                                 </li>
                                 <li>
                                    <h4 style="font-size: 11px;color:green;font-weight: 600;">Extra Charge</h4>
                                    <h5 style="font-size: 11px;color:green;font-weight: 600;">₹ <span  class="">{{ $extracostamount}}</span></h5>
                                 </li>
                                 <li class="">
                                    <h4 style="font-size: 11px;color:blue;font-weight: 600;">Gross Amount</h4>
                                    <h5 style="font-size: 11px;color:blue;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->gross_amount}}</span></h5>
                                 </li>
                                 <li class="">
                                    <h4 style="font-size: 11px;color:red;font-weight: 600;">Old Balance</h4>
                                    <h5 style="font-size: 11px;color:red;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->old_balance}}</span></h5>
                                 </li>
                                 <li>
                                    <h4 style="font-size: 11px;color:blue;font-weight: 600;">Grand Total</h4>
                                    <h5 style="font-size: 11px;color:blue;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->grand_total}}</span></h5>
                                 </li>
                                 <li class="">
                                    <h4 style="font-size: 11px;color:green;font-weight: 600;">Paid Amount</h4>
                                    <h5 style="font-size: 11px;color:green;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->paid_amount}}</span></h5>
                                 </li>
                                 <li class="">
                                    <h4 style="font-size: 11px;color:red;font-weight: 600;">Nett Balance</h4>
                                    <h5 style="font-size: 11px;color:red;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->balance_amount}}</span></h5>
                                 </li>
                              </ul>
                           </div>
                        </div>
