        ...
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" method="POST"
                    action="{{ route('purchase.invoice_update', ['unique_key' => $PurchaseData->unique_key]) }}"
                    ...
                    <div class="row">
                        <div class="table-responsive col-12">
                            <table class="table">
                                    ...
                                    @foreach ($PurchaseProducts as $index => $Purchase_Products)
                                        <tr>
                                            ...
                                            <td class="text-end"><input type="text" class="form-control total_price"
                                                    id="total_price" style="background-color: #e9ecef;" name="total_price[]"
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input commission_ornet" type="radio"
                                        ...
                                        <td><input type="text" style="display:none" value=""
                                                class="form-control commission_percent" name="commission_percent"
                                                id="commission_percent" /></td>
                                        <td><input type="text" class="form-control commission_amount" readonly
                                                name="commission_amount" id="commission_amount" value="" /></td>
                                        <td></td>
                                    </tr>
                                </tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"><input type="hidden" name="purchase_extracost_id" />
                                            <input type="text" class="form-control" id="extracost_note"
                                                placeholder="Note" value="" name="extracost_note[]" required />
                                        </td>

                                        <td><input type="text" class="form-control extracost" id="extracost"
                                                placeholder="Extra Cost" required name="extracost[]" value="" />
                                        </td>
                                        <td><button
                                                style="width: 35px;"class="py-1 addextranotefields text-white font-medium rounded-lg text-sm  text-center btn btn-primary"
                                                type="button" id="" value="Add">+</button>
                                            <button
                                                style="width: 35px;"class="py-1 text-white remove-extratr font-medium rounded-lg text-sm  text-center btn btn-danger"
                                                type="button" id="" value="Add">-</button>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: black;">Total
                                        </td>
                                        <td><input type="hidden" class="form-control total_extracost" value=""
                                                name="total_extracost" id="total_extracost" readonly />
                                            <input type="text" class="form-control tot_comm_extracost" value=""
                                                readonly name="tot_comm_extracost" style="background-color: #e9ecef;" />
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: black;">Gross
                                            Amount</td>
                                        <td colspan="2"><input type="text" class="form-control gross_amount"
                                                id="gross_amount" placeholder="Gross Amount"
                                                value="{{ $PurchaseData->gross_amount }}" readonly
                                                style="background-color: #e9ecef;" name="gross_amount" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: red;">Old
                                            Balance</td>
                                        <td colspan="2"><input type="text" class="form-control old_balance"
                                                id="old_balance" placeholder="Old Balance" readonly value="0"
                                                style="background-color: #e9ecef;" name="old_balance" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: green;">Grand
                                            Total</td>
                                        <td colspan="2"><input type="text" class="form-control grand_total"
                                                id="grand_total" readonly placeholder="Grand Total"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <select class="form-control js-example-basic-single select" name="bank_id"
                                                id="bank_id" required>
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-primary" value="Gendrate Pattial" />
