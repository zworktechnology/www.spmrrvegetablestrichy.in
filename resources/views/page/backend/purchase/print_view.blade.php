                  ...
                  <span style="font-size:17px" >Date: &nbsp;<span style="font-weight:600">{{ date('d-m-Y', strtotime($PurchaseData->date))}}</span></span>
                     ...
                     <table style="width: 100%;line-height: inherit;text-align: left;overflow: auto;margin:15px auto;">
                        <tr class="heading " style="background:#eee;">
                           <td style="padding: 5px;vertical-align: middle;font-weight: 600;color: black;font-size: 15px;padding: 10px; ">
                           Product Name
                           </td>
                           <td style="padding: 5px;vertical-align: middle;font-weight: 600;color: black;font-size: 15px;padding: 10px; ">
                           Bag / Kg
                        ...
                        <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                           <td style="padding: 10px;vertical-align: top; vertical-align: inherit;vertical-align: inherit;font-size: 15px;color:#000;font-weight: 600;">
                     ...
                     <div class="row">
                           <div class="col-lg-7  col-sm-6 col-6"></div>
                              ...
                              <div class="total-order w-100 max-widthauto mb-4">
                                 <ul>
                                    ...
                                    <li class="">
                                       ...
                                       <h5 style="font-size: 15px;color:blue;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->gross_amount}}</span></h5>
                                    </li>
                                    <li class="">
                                       <h4 style="font-size: 15px;color:red;font-weight: 600;">Old Balance</h4>
                                       <h5 style="font-size: 15px;color:red;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->old_balance}}</span></h5>
                                    </li>
                                    <li>
                                       <h4 style="font-size: 15px;color:blue;font-weight: 600;">Grand Total</h4>
                                       <h5 style="font-size: 15px;color:blue;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->grand_total}}</span></h5>
                                    </li>
                                    <li class="">
                                       <h4 style="font-size: 15px;color:green;font-weight: 600;">Paid Amount</h4>
                                       <h5 style="font-size: 15px;color:green;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->paid_amount}}</span></h5>
                                    </li>
                                    <li class="">
                                       <h4 style="font-size: 15px;color:red;font-weight: 600;">Nett Balance</h4>
                                       <h5 style="font-size: 15px;color:red;font-weight: 600;">₹ <span  class="">{{ $PurchaseData->balance_amount}}</span></h5>
                                    </li>
                                 </ul>    
                              </div>
                           </div>
