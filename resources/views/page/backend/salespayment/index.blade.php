            ...
            <div class="col-lg-2 col-sm-4 col-6" style="width: 12%">
                <a href="{{ route('salespayment.index') }}" style="color: black">
                    <div class="dash-widget"
                        @if ($pos == 'salespayment') style="border-color:red; background-color: red;" @endif>
            ...
            @foreach ($allbranch as $keydata => $allbranches)
                <div class="col-lg-2 col-sm-4 col-6" style="width: 12%">
                    <a href="/salespayment_branchdata/{{ $today }}/{{ $allbranches->id }}" style="color: black">
                        <div
                            class="dash-widget"@if ($last_word == $allbranches->id) style="border-color:red; background-color: red;" @endif>
                            <div class="dash-widgetcontent">
