                ...
                <div class="row">
                    <div style="display: flex;">
                        ...
                        <a href="{{ route('purchase.create') }}" class="btn btn-added"
                            style="margin-right: 10px;background-color: #0f3800;">Add
                            Purchase</a>
                    </div>
                </div>
            </div>
            ...
            @foreach ($allbranch as $keydata => $allbranches)
                <div class="col-lg-2 col-sm-4 col-6" style="width: 12%">
                    ...
                    {{-- <a href="#todaystock{{ $allbranches->id }}" data-bs-toggle="modal"data-id="{{ $allbranches->id }}"
                        data-bs-target=".todaystock-modal-xl{{ $allbranches->id }}" class="btn btn-added "
                        style="color:white;background-color: #0f3800;font-size: 13px;font-weight: 600;">Current Details</a> --}}
                                            ...
                                            @if ($purchasedata['status'] == 0)
                                                <li>
                                                    ...
                                                    <a href="{{ route('purchase.invoice', ['unique_key' => $purchasedata['unique_key']]) }}"
                                                        class="badges bg-lightgreen purchase_pattiyal" style="color: white"
                                                        data-id="{{ $purchasedata['unique_key'] }}">
                                                        Pattial</a>
                                                </li>
