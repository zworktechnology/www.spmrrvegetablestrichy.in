                            ...
                            <table class="table">
                                ...
                                <tbody class="sales_productfields">
                                    <tr>
                                        ...
                                        <td>
                                            <button
                                                style=" width: 35px;"class="addsalesproductfields py-1 text-white font-medium rounded-lg text-sm  text-center btn btn-primary"
                                                type="button" id="" value="Add">+</button>
                                            <button style="width: 35px;"
                                                class="py-1 text-white font-medium rounded-lg text-sm  text-center btn btn-danger remove-salestr"
                                                type="button">-</button>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="1"><input type="text" class="form-control sales_total_amount"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"><input type="text" class="form-control"
                                                ...
                                                value="No" /></td>
                                        <td colspan="1"><input type="text" class="form-control sales_extracost"
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: black;">Gross
                                            Amount</td>
                                        <td colspan="1"><input type="text" class="form-control sales_gross_amount"
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: red;">Old
                                            Balance</td>
                                        <td colspan="1"><input type="text" class="form-control sales_old_balance"
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: green;">Grand
                                            Total</td>
                                        <td colspan="1"><input type="text" class="form-control sales_grand_total"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1"><input type="text" class="form-control salespayable_amount"
