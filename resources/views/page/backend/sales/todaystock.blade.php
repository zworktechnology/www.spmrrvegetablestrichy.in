                     ...
                     <div class="col-lg-12 col-sm-12 col-12">
                      ...
                      @if ($allbranches->id == $p_datas['branch_id'])
                        ...
                        <div class="row">
                              ...
                              <div class="col-lg-8 col-sm-8 col-8 border">
                                 <span class=""style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;line-height: 35px; ">{{$p_datas['product_name']}}</span>
                              </div>

                             
                              <div class="col-lg-1 col-sm-1 col-1 border">
                                <span class="" style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 700;line-height: 35px; ">{{$p_datas['Pbagcount']}}</span>
                             </div>
                             

                            
                             <div class="col-lg-1 col-sm-1 col-1 border">
                                 <span class="" style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 700;line-height: 35px; ">{{$p_datas['Pkgcount']}}</span>
                              </div>
                             
                              <div class="col-lg-1 col-sm-1 col-1 border">
                                 <span class="" style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 700;line-height: 35px; ">{{$p_datas['Sbagcount']}}</span>
                              </div>
                             <div class="col-lg-1 col-sm-1 col-1 border">
                                <span class="" style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 700;line-height: 35px; ">{{$p_datas['Skgcount']}}</span>
                             </div>
                        </div>
                        @endif
                        @endforeach
