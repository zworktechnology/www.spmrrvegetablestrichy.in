                        ...
                        <div class="col-lg-4 col-sm-4 col-12">
                            <div class="form-group">
                                <label style="font-size:15px;padding-top: 5px;padding-bottom: 2px;">Time<span
                                        style="color: red;">*</span></label>
                                <input type="time" name="time" placeholder="" value="{{ $PurchaseData->time }}" disabled style="background-color: #e9ecef;">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4 col-12">
                            <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: black;">Gross
                                            Amount</td>
                                        <td><input type="text" class="form-control gross_amount" id="gross_amount"
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: red;">Old
                                            Balance</td>
                                        <td><input type="text" class="form-control old_balance" id="old_balance"
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: green;">Grand
                                            Total</td>
                                        <td><input type="text" class="form-control grand_total" id="grand_total"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control payable_amount"
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end" style="font-size:15px;color: black;">Pending
                                            Amount</td>
                                        <td><input type="text" class="form-control pending_amount"
